...
/*!
 * @file KeylessShapeType.hpp
 * This header file contains the declaration of the described types in the IDL file.
 *
 * This file was generated by the tool fastddsgen (version: 4.0.7).
 */

#ifndef FAST_DDS_GENERATED__KEYLESSSHAPETYPE_IDL_SHAPES_DEMO_TYPESUPPORT_IDL_HPP
#define FAST_DDS_GENERATED__KEYLESSSHAPETYPE_IDL_SHAPES_DEMO_TYPESUPPORT_IDL_HPP
...
public:
     ...
     * @param x Reference to the object KeylessShapeType that will be copied.
     */
    eProsima_user_DllExport KeylessShapeType(
     ...
     * @param x KeylessShapeType object to compare.
     */
...
#endif // _FAST_DDS_GENERATED_KEYLESSSHAPETYPE_IDL_SHAPES_DEMO_TYPESUPPORT_IDL_HPP_
