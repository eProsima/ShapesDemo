...
namespace shapes_demo_typesupport {
    namespace idl {
        KeylessShapeTypePubSubType::KeylessShapeTypePubSubType()
        {
            ...
            m_isGetKeyDefined = KeylessShapeType::isKeyDefined();
            size_t keyLength = KeylessShapeType::getKeyMaxCdrSerializedSize() > 16 ?
                    KeylessShapeType::getKeyMaxCdrSerializedSize() : 16;
                ...
                bool force_md5)
        {
            ...
            eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),
                    KeylessShapeType::getKeyMaxCdrSerializedSize());

            // Object that serializes the data.
            eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::BIG_ENDIANNESS);
            p_type->serializeKey(ser);
            if (force_md5 || KeylessShapeType::getKeyMaxCdrSerializedSize() > 16)
            {
                m_md5.init();
