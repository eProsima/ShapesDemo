...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        OptionsDialog->resize(494, 364);
        widget = new QWidget(OptionsDialog);
        widget->setObjectName(QString::fromUtf8("widget"));
        widget->setGeometry(QRect(9, 12, 470, 330));
        ...
        pushButton_udp = new QPushButton(widget);
        ...
        pushButton_tcp_server = new QPushButton(widget);
        ...
        spin_listen_port = new QSpinBox(widget);
        ...
        pushButton_tcp_client = new QPushButton(widget);
        ...
        gridLayout->addWidget(pushButton_tcp_client, 2, 1, 2, 1);
        ...
        gridLayout->addWidget(label_9, 3, 2, 2, 1);

        lineEdit_wam_ip = new QLineEdit(widget);
        lineEdit_wam_ip->setObjectName(QString::fromUtf8("lineEdit_wam_ip"));

        gridLayout->addWidget(lineEdit_wam_ip, 4, 3, 1, 1);
        ...
        spin_server_port = new QSpinBox(widget);
        ...
        gridLayout->addWidget(spin_server_port, 5, 3, 1, 1);
        ...
        gridLayout->addWidget(pushButton_stop, 6, 3, 1, 1);
        ...
        spin_updateInterval = new QSpinBox(widget);
        ...
        horizontalSlider_speed = new QSlider(widget);
        ...
        gridLayout->addWidget(horizontalSlider_speed, 10, 1, 1, 1);
        ...
        QWidget::setTabOrder(pushButton_tcp_server, pushButton_tcp_client);
        QWidget::setTabOrder(pushButton_tcp_client, spin_listen_port);
        QWidget::setTabOrder(spin_listen_port, lineEdit_server_ip);
        QWidget::setTabOrder(lineEdit_server_ip, lineEdit_wam_ip);
        QWidget::setTabOrder(lineEdit_wam_ip, spin_server_port);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        label_9->setText(QApplication::translate("OptionsDialog", "WAN IP:", nullptr));
