...
4.  Load the Docker image:
        ...
        $ docker load -i ubuntu-fast-dds-shapesdemo:2.3.0.tar

5.  Run the Docker image:

        $ docker run -it --privileged -e DISPLAY=$DISPLAY -v /tmp/.X11-unix:/tmp/.X11-unix ubuntu-fast-dds-shapesdemo:v2.3.0
